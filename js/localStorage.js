...
function loadFromLocalStorage() {
  ...
  totalRounds = localStorage.getItem("totalRounds") ? parseInt(localStorage.getItem("totalRounds")) : 25;
  roundsCount = localStorage.getItem("roundsCount") ? parseInt(localStorage.getItem("roundsCount")) : 25;
